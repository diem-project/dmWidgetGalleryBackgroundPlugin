...
class dmWidgetContentGalleryBackgroundForm extends dmWidgetPluginForm
{
  protected static
  $methods = array(
    'center' => 'Center',
  ...
  public function getStylesheets()
  {
    return array(
      'lib.ui-tabs',
      'dmWidgetGalleryBackgroundPlugin.form'
    );
  }
  ...
  {
    return $this->getHelper()->renderPartial('dmWidgetGalleryBackground', 'form', array(
      'form' => $this,
      'medias' => $this->getMedias(),
      'baseTabId' => 'dm_widget_gallery_background_'.$this->dmWidget->get('id')
    ));
  }
